...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   그렇기 떄문에 하나의 타입을 여러 타입의 인스턴스를 처리할 수 있기도 하고,
        ...
        *    */
        ...
        /* 목차. 3. 호랑이 인스턴스 생성 후 메소드 호출 확인 */
        System.out.println("=================호랑이 생성================== ");
        호랑이 tiger = new 호랑이();
        tiger.먹기();
        tiger.달리기();
        tiger.울기();
        tiger.물어뜯기(); // 호랑이도 부모의 메소드 뿐 아니라 본인의 메소드도 가졌다 .
...
//        a2.물어뜯기;
        ...
        *   메소드 호출이 가능하다.
        *   class type casting : 클래스 형변황
        *  */

        System.out.println("====================클레스 형변환 확인===================");
        ((토끼)a1).점프();
        ((호랑이)a2).물어뜯기();
...
//        ((호랑이)a1).물어뜯기(); // 토끼는 호랑이가 될 수 없다. RuntimeException 번역은 문제가 없지만, 프로그램 동작 시 오류 발생
        ...
        /* 필기. 래퍼런스 변수가 참조하는 실제 인스턴스가 원하는 타입과 맞는 지 비교하는 연산자 */
        ...
        /* 필기.
        *   instanceod 연산자를 이용해서 해당 타입이 맞는 경우에만 클래스 형변환 적용
        *  */
        System.out.println("=============================================");
        if (a1 instanceof 토끼){
            ((토끼) a1).점프();
        ...
        /* 필기.
        *   클래스 형변환 up-casting 과 down-casting 으로 구분할 수 있다.
        ...
        *    */
        ...
        동물 a4 = new 토끼();      // down-casting 묵시적 형변환
