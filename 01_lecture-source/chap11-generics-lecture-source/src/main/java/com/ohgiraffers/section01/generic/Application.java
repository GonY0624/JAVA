...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   자바네서 제네릭이란, 데이터의 타입을 일반화 한다는 의미를 가진다.
        *
        *  필기.
        *   제네릭은 클래스나 메소드에서 사용할 내부 제이터 타입을 컴파일 시에 지정하는 방법을 말한다.
        *   컴파일 시에 미리 타입 검사를 시행하게 되면 클래스나 메소드 내부에서 사용되는 객체 타입
        *   안전성을 높일 수 있으며, (잘못 된 타입인 경우 컴파일 에러를 발생시킴.)
        *   반환값에 대한 타입 변환 및 타입 검사에 들어가는 코드 생략이 가능해진다.
        *   (instanceof 비교 및 다운캐스팅 작성 불필요)_ 타입을 정해서 검사 불필요라는 말
        *
        *  필기.
        *   제네릭 프로그래밍
