...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기. 제네릭은 타입을 제한한다~ 정도만 알아둬도 충분히 사용 가능 */

        /* 수업목표. 와일드카드에 대해 이해할 수 있다.  */
        /* 필기.
        *   와일드카드(WildCard)
        *   제네릭 클래스 타입의객체를 메소드의 매ㅅ개변수로 받을 때,
        *   그 객체의 타입 변수를 제한 할 수 있다.
        *   <?> : 제한 없음
        *   <? extends Type> : 와일드 카드 상한제한(Type 과 Type 의 후손을 이용해 생성한 인스턴스만 가능)
        *   <? super Type> : 와일드 카드 하한제한(Type 과 Type 의 부모를 이용해 생성한 인스턴스만 가능)
        *  */
...
//        wildCardFarm.anyType(new RabbitFarm<Reptile>(new Reptile));
        ...
        /* 필기. Bunny 이거나 Bunny 의 후손들만 매개변수로 사용이 가능하다.  */
